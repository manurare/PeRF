...
for scene in apartment_0 apartment_1 apartment_2 frl_apartment_0 frl_apartment_1 frl_apartment_2 frl_apartment_3 frl_apartment_4 frl_apartment_5 hotel_0 office_0 office_1 office_2 office_3 office_4 room_0 room_1 room_2 ; do
    ...
    python core_exp_runner.py --config-name nerf dataset.image_path=$input_image_path +dataset.depth_path=$input_depth_path device.base_exp_dir=$expname
    python core_exp_runner.py --config-name nerf dataset.image_path=$input_image_path device.base_exp_dir=$expname mode=render_dense is_continue=true
